...
_C_LIB_DECL
extern int __8051abi_MB_CUR_MAX(void);
_END_C_LIB_DECL

#if __8051ABI_PORTABILITY_INTERNAL_LEVEL
  #ifndef __8051ABI_PORTABLE
    #define __8051ABI_PORTABLE
  #endif

  #define MB_CUR_MAX    (_CSTD __8051abi_MB_CUR_MAX())

#else /* __8051ABI_PORTABILITY_INTERNAL_LEVEL  */

  #define MB_CUR_MAX    (_ENCODING_CUR_MAX)

#endif /*  __8051ABI_PORTABILITY_INTERNAL_LEVEL */
...
#if __8051ABI_PORTABILITY_INTERNAL_LEVEL == 0
...
#endif /* __8051ABI_PORTABILITY_INTERNAL_LEVEL == 0 */
